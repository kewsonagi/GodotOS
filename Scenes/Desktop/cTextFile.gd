...
func DeleteFile() -> void:
	...
	NotificationManager.ShowNotification("Moved [color=59ea90][wave freq=7]%s[/wave][/color] to trash!" % szFileName, NotificationManager.E_NOTIFICATION_TYPE.NORMAL, "Trashed file")
	queue_free()